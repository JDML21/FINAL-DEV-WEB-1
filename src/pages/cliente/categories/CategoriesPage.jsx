...
function CategoriesPage() {
  ...
  return (
    <div className="pt-20 min-h-screen bg-gray-50 p-6"> {/* Mismo padding-top que otras vistas */}
      <div className="max-w-7xl mx-auto"> {/* Contenedor máximo como en otras vistas */}
        {/* Header idéntico al de otras vistas */}
        <div className="mb-8">
