...
function Editproductpage() {
  ...
  const handleGuardar = () => {
    const nuevoProducto = {
      ...localProduct,
      [campoEditando]: isNaN(nuevoValor) ? nuevoValor : Number(nuevoValor),
    };
    setLocalProduct(nuevoProducto);
    updateProduct(id, { [campoEditando]: nuevoProducto[campoEditando] });
    ...
    <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      >
        {[
          ...
          >
            <div>
              <strong>{label}:</strong> <span>{localProduct[campo]}</span>
            </div>
      ...
      {campoEditando && (
        ...
        >
          ...
          >
            ...
            <p><strong>Actual:</strong> {localProduct[campoEditando]}</p>
            <input
              type="text"
              value={nuevoValor}
